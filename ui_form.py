...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_print_widjet = QLabel(self.tab_SQL_Base_connect)
        self.label_print_widjet.setObjectName(u"label_print_widjet")
        self.label_print_widjet.setGeometry(QRect(750, 40, 301, 201))
        ...
        font1.setBold(True)
        self.label_Space_Name.setFont(font1)
        ...
        self.label_Text_Space.setGeometry(QRect(170, 20, 591, 50))
        font2 = QFont()
        font2.setFamilies([u"Times New Roman"])
        font2.setPointSize(16)
        font2.setBold(True)
        self.label_Text_Space.setFont(font2)
        ...
        self.label_Year.setGeometry(QRect(10, 80, 151, 51))
        ...
        self.label_Text_Year.setGeometry(QRect(170, 80, 591, 51))
        self.label_Text_Year.setFont(font2)
        self.label_Text_Year.setStyleSheet(u"background-color: rgb(247, 247, 247);")
        self.label_Text_Year.setMargin(10)
        self.btn_Connect_SQL_DB_2 = QPushButton(self.tab)
        self.btn_Connect_SQL_DB_2.setObjectName(u"btn_Connect_SQL_DB_2")
        self.btn_Connect_SQL_DB_2.setGeometry(QRect(170, 140, 591, 28))
        self.age_structure_calculation.addTab(self.tab, "")
        self.tab_3 = QWidget()
        ...
        self.lbl_tab_age_struct_table_list = QLabel(self.verticalLayoutWidget)
        self.lbl_tab_age_struct_table_list.setObjectName(u"lbl_tab_age_struct_table_list")
        font3 = QFont()
        font3.setUnderline(False)
        font3.setStrikeOut(False)
        self.lbl_tab_age_struct_table_list.setFont(font3)

        self.verticalLayout_2.addWidget(self.lbl_tab_age_struct_table_list)
        ...
        self.lbl_tab_age_struct_type_list = QLabel(self.gridLayoutWidget)
        self.lbl_tab_age_struct_type_list.setObjectName(u"lbl_tab_age_struct_type_list")

        self.gridLayout_4.addWidget(self.lbl_tab_age_struct_type_list, 0, 0, 1, 1)

        self.lbl_tab_age_struct_year_list = QLabel(self.gridLayoutWidget)
        self.lbl_tab_age_struct_year_list.setObjectName(u"lbl_tab_age_struct_year_list")

        self.gridLayout_4.addWidget(self.lbl_tab_age_struct_year_list, 1, 0, 1, 1)
        ...
        self.lbl_tab_age_struct_area_list = QLabel(self.verticalLayoutWidget_2)
        self.lbl_tab_age_struct_area_list.setObjectName(u"lbl_tab_age_struct_area_list")

        self.verticalLayout_3.addWidget(self.lbl_tab_age_struct_area_list)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_print_widjet.setText("")
        ...
        self.btn_Connect_SQL_DB_2.setText(QCoreApplication.translate("MainWindow", u"Connect", None))
        self.age_structure_calculation.setTabText(self.age_structure_calculation.indexOf(self.tab), QCoreApplication.translate("MainWindow", u"\u0412\u044b\u0431\u043e\u0440 \u0432\u0438\u0434\u0430", None))
        self.lbl_tab_age_struct_table_list.setText(QCoreApplication.translate("MainWindow", u"\u0412\u044b\u0431\u0435\u0440\u0438\u0442\u0435 \u0442\u0430\u0431\u043b\u0438\u0446\u0443 \u0431\u0438\u043e\u0430\u043d\u0430\u043b\u0438\u0437\u0430", None))
        self.lbl_tab_age_struct_type_list.setText(QCoreApplication.translate("MainWindow", u"\u0412\u0438\u0434\u044b", None))
        self.lbl_tab_age_struct_year_list.setText(QCoreApplication.translate("MainWindow", u"\u0413\u043e\u0434\u0430", None))
        self.lbl_tab_age_struct_area_list.setText(QCoreApplication.translate("MainWindow", u"\u041c\u0435\u0441\u0442\u0430 \u043b\u043e\u0432\u0430", None))
